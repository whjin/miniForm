...
let targetHost = "";
const hosts = "192.168.2.145".split(",");
setTimeout(() => {
  index.request({
  ...
  list: [
    {
      ...
      selectedIconPath: "static/images/tabs/index_s.png",
      text: "主页"
    },
    {
      pagePath: "pages/personal/index",
      iconPath: "static/images/tabs/personal.png",
      selectedIconPath: "static/images/tabs/personal_s.png",
      text: "我的"
    }
  ]
};
...
var define_process_env_UNI_STAT_TITLE_JSON_default = { "pages/index/index": "主页", "pages/personal/index": "我的" };
var define_process_env_UNI_STAT_UNI_CLOUD_default = {};
const sys = index.getSystemInfoSync();
const STAT_VERSION = "4.36";
    ...
    }
    {
      ...
      if (!index.__stat_uniCloud_space) {
        if (space && Object.keys(space).length !== 0) {
          ...
          index.__stat_uniCloud_space = Zs.init(spaceData);
        } else {
